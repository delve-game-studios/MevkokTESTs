...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head> 
        ...
        <!-- This page, code and content is copyrighted material owned by Martin Korner. --><style type="text/css">/*
         ...
         # # For further legal details, please visit www.martinkorner.co.uk/legal.htm */
            ...
            body {background:#4a8ad3 url(<?php echo routeTo('/public/error/500.jpg') ?>); font-family:Arial, Helvetica, sans-serif; color:#000; font-size:16px;}
    ...
    <body> 
        ...
        <div id="position"> 
            ...
            <div class="h1">The page or domain name is not accessible. Please try again later.</div>
